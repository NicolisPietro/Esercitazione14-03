...
int main(int argc, char* argv[])
{
 ...
 fifo = open("my_fifo", O_WRONLY);//O_WRONLY è una costante usata nelle chiamate di apertura file
 //il suo scopo è quello di evitare l'apertura accidentale di un file
 if (fifo < 0)
 {
